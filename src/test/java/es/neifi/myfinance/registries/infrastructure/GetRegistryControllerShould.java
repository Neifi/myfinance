package es.neifi.myfinance.registries.infrastructure;
...
import es.neifi.myfinance.registry.infrastructure.GetExpenseController;
...
class GetRegistryControllerShould {
    ...
    void return_http_status_200_with_existent_user_and_expense() throws Exception {
        ...
        when(expenseSearcher.search("787f28f2-003a-4445-8659-d60683107845")).thenReturn(java.util.Optional.ofNullable(registry));
    ...
    void return_http_status_200_with_list_of_expenses() throws Exception {
        ...
        when(userService.search("2be27975-4d87-413b-991c-ceff0bb960db")).thenReturn(user);
        when(expenseSearcher.search()).thenReturn(Arrays.asList(registry, registry1));
    ...
    void return_http_status_200_with_list_of_expenses_in_time_period() throws Exception {
        ...
        when(userService.search("2be27975-4d87-413b-991c-ceff0bb960db")).thenReturn(user);
        when(expenseSearcher.search("01/06/2021","31/06/2021")).thenReturn(Arrays.asList(registry, registry1));
