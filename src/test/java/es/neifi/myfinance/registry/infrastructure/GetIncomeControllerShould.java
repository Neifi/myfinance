...
class GetIncomeControllerShould {
    ...
    void return_http_status_200_with_existent_user_and_income() throws Exception {
        ...
        ResultMatcher resultMatcher = content().string("{\"userId\":\"053e7ba6-b1d6-4dcb-8047-bbb0cf7a0b99\",\"id\":\"787f28f2-003a-4445-8659-d60683107845\",\"category\":\"home\",\"name\":\"internet\",\"cost\":100.0,\"currency\":\"EUR\",\"date\":" + date + ",\"income\":true}");
    ...
    void return_http_status_200_with_list_of_incomes() throws Exception {
        ...
        ResultMatcher resultMatcher = content().string("{\"incomes\":[{\"userId\":\"" + userId + "\",\"id\":\"787f28f2-003a-4445-8659-d60683107845\",\"category\":\"home\",\"name\":\"internet\",\"cost\":100.0,\"currency\":\"EUR\",\"date\":" + date + ",\"income\":true},{\"userId\":\"2be27975-4d87-413b-991c-ceff0bb960db\",\"id\":\"13dd4c9b-908a-4712-9799-bfa8e445db0a\",\"category\":\"home\",\"name\":\"internet\",\"cost\":100.0,\"currency\":\"EUR\",\"date\":" + date + ",\"income\":true}],\"totalExpended\":200.0,\"timePeriod\":[null,null]}");
    ...
    void return_http_status_200_with_list_of_incomes_in_time_period() throws Exception {
        ...
        ResultMatcher resultMatcher = content().string("{\"incomes\":[{\"userId\":\"" + userId + "\",\"id\":\"787f28f2-003a-4445-8659-d60683107845\",\"category\":\"home\",\"name\":\"internet\",\"cost\":100.0,\"currency\":\"EUR\",\"date\":" + date + ",\"income\":true},{\"userId\":\"787f28f2-003a-4445-8659-d60683107845\",\"id\":\"787f28f2-003a-4445-8659-d60683107845\",\"category\":\"home\",\"name\":\"internet\",\"cost\":100.0,\"currency\":\"EUR\",\"date\":" + date1 + ",\"income\":true}],\"totalExpended\":200.0,\"timePeriod\":[" + initialDate + "," + endDate + "]}");
        when(userService.search(userId)).thenReturn(user);
